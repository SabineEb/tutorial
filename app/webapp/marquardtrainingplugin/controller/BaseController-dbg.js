sap.ui.define(
  ...
  "com/systemagmbh/marquardtrainingplugin/builder/localPodConfigs",
  "com/systemagmbh/marquardtrainingplugin/data/localPodSelectionModelData"
    ...
    return PluginViewController.extend(
      "com.systemagmbh.marquardtrainingplugin.controller.BaseController",
      {
        ...
        getResource: function () {
          if(this.getPodSelectionModel() && this.getPodSelectionModel().resource != undefined){
            return this.getPodSelectionModel().resource.resource;
          }else{
        ...
        getSfc: function () {
          if(this.getPodSelectionModel() && this.getPodSelectionModel().getSelection().input != undefined){
            return this.getPodSelectionModel().getSelection().input;
          }else{
            return this.zPodSelectionModel.getProperty("/loginData/sfc");
          }
        },

        getOrder: function () {
          if(this.getPodSelectionModel() && this.getPodSelectionModel().getSelection().shopOrder != undefined){
            return this.getPodSelectionModel().getSelection().shopOrder.shopOrder;
          }else{
            return this.zPodSelectionModel.getProperty("/loginData/shopOrder");
          }
        },

        getMaterial: function () {
          if(this.getPodSelectionModel() && this.getPodSelectionModel().getSelection().item != undefined){
            return this.getPodSelectionModel().getSelection().item.item;
          }else{
            return this.zPodSelectionModel.getProperty("/loginData/material");
          }
        },
